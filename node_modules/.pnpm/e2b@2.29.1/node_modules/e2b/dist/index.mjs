...
var DEFAULT_ERROR_MAP2 = {
  ...
  [Code2.ResourceExhausted]: (message) => new RateLimitError(
...
var Filesystem2 = class {
  ...
  async write(pathOrFiles, dataOrOpts, opts) {
    ...
    if (metadata && Object.keys(metadata).length > 0 && compareVersions2(this.envdApi.version, ENVD_FILE_METADATA) < 0) {
  ...
  async watchDir(path2, onEvent, opts) {
    ...
    if ((opts == null ? void 0 : opts.includeEntry) && this.envdApi.version && compareVersions2(this.envdApi.version, ENVD_VERSION_FS_EVENT_ENTRY_INFO) < 0) {
      throw new TemplateError(
