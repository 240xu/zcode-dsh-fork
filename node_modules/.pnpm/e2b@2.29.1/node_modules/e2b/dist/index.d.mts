...
interface paths {
    ...
    "/sandboxes/{sandboxID}/network": {
        ...
        put: {
            ...
            requestBody: {
                content: {
                    "application/json": components$1["schemas"]["SandboxNetworkUpdateConfig"];
                };
            };
            responses: {
...
interface components$1 {
    schemas: {
        ...
        SandboxNetworkConfig: {
             ...
             *      */
            rules?: {
                [key: string]: components$1["schemas"]["SandboxNetworkRule"][];
            };
        };
        /** @description Transform rule applied to egress requests matching a domain pattern. */
        SandboxNetworkRule: {
            transform?: components$1["schemas"]["SandboxNetworkTransform"];
        };
 ...
 */
interface SandboxApiOpts extends Partial<Pick<ConnectionOpts, 'apiKey' | 'headers' | 'apiHeaders' | 'debug' | 'domain' | 'requestTimeoutMs' | 'signal'>> {
}
/**
...
declare class Sandbox extends SandboxApi {
     ...
     * @param opts connection options.
     */
    kill(opts?: Pick<SandboxOpts, 'requestTimeoutMs' | 'signal'>): Promise<void>;
    /**
