...
export function PendingSubmissionBubble({ submission, renderMessageImages, t }) {
    ...
    return (_jsx(UserStyleBubble, { content: content, previewImages: previewImages, renderMessageImages: renderMessageImages, pending: submission.placement === 'steering', echo: true, t: t, actions: text => (_jsx(MessageIconActions, { text: text, time: submission.time, clock: "start", className: css.actions, t: t })) }));
}
