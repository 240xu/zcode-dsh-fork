...
export function ToolRow({ t, variant, toolName, icon, title, summary, summarySuffix, bodyRaw, output, askQuestion, errorSummary, terminal, diff, read, image, renderSlot, loadImage, search, web, state, filePath, onOpenFile, inspect, }) {
    ...
    return (_jsxs("div", { className: css.root, "data-variant": variant, "data-tool": toolName, "data-state": state, children: [status !== null && _jsx("span", { className: css.visuallyHidden, children: status }), _jsx(DisclosureRow, { rowClassName: css.row, leadingClassName: css.leading, titleClassName: css.title, chevronClassName: css.chevron, icon: leadingFor(state, icon), title: title, open: open, expandable: expandable, expandOnRowClick: true, keepContentWhenOpen: true, onToggle: toggleExpand, collapsedContent: summaryText !== '' && (_jsxs(_Fragment, { children: [_jsx("span", { className: css.sep, "aria-hidden": true }), fileLink ? (_jsx("button", { type: "button", className: css.fileLink, onClick: openFile, onKeyDown: fileLinkKeyDown, children: summaryText })) : (_jsx("span", { className: clsx(css.summary, failureLine !== null && css.errorSummary), children: summaryText })), suffix !== null && (_jsx("span", { className: clsx(css.summarySuffix, suffix === diffStat && css.diffStat), children: suffix }))] })), children: _jsxs("div", { className: css.bodyWrap, children: [askQuestionBody !== null
