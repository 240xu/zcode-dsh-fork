...
export function GenericToolCard({ toolName, block, cwd, home, openFile, inspect, t }) {
    ...
    return (_jsx(ToolRow, { t: t, variant: model.variant, toolName: toolName, icon: VARIANT_ICONS[model.variant], title: t(model.titleKey), summary: model.summary, 
        ...
        bodyRaw: singleFile ? null : model.bodyRaw, output: model.output, errorSummary: model.errorSummary, terminal: terminal, diff: diff, read: read, search: search, web: web, state: state, filePath: model.filePath, onOpenFile: singleFile ? openFile : undefined, inspect: inspect }));
}
