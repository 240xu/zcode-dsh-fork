// Ported from zai-org/ZCode@872ad96 apps/zcode-cli/packages/core/src/context/sections/memory.ts
// Ported from zai-org/ZCode@872ad96 apps/zcode-cli/packages/core/src/context/sections/memory.ts
// buildMemoryContent is verbatim; the ContextSection wrapper is dropped and
// the content builder is exported as buildMemoryText(memoryRoot).

export function buildMemoryText(memoryRoot: string): string {
  return [
    "# Memory",
    "",
